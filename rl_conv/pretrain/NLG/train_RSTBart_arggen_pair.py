...
class RSTBartPair(RSTBart):
    ...
    @classmethod
    def load_model_tokenizer(cls, model_name="RSTBartPair", model_version=None, mparams_new={}, device="cuda:0"):
        ...
        if False and step_name == "val" and _get_rank() == 0:
            ...
            for idx, encoded_input_ in enumerate(self.inference_samples):
                ...
                bad_words_ids = bad_words_ids + \
                    [self.tokenizer.encode(bad_word) for bad_word in bad_words]
                bad_words_ids = bad_words_ids 
