...
class RSTPlanner():
    ...
    def __init__(self, model_name='rst_planner', dirs_rst_convo="./dataset_v3",
    ...
    def parse_args():
        ...
        parser.add_argument('-drc', '--dirs_rst_convo', default=os.path.abspath("./dataset_v3"), required=False)
        parser.add_argument('-mcnp', '--maximum_child_node_pos', default=4094)
        parser.add_argument('-df','--data_filters', default="{}",help="filters related to input dataset. args of filter_rstseq" )
...
def main(mparams):
    ...
    for subreddit in rst_planner.li_subreddit_names:
        ...
        rst_planner.create_markovian_distr(subreddit, data_filters )
    ...
    rst_planner.create_markovian_distr("aggregated", data_filters)
